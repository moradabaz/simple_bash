...
import static es.um.poa.agents.fishmarket.FishMarketAgent.isSubastando;
import static es.um.poa.agents.fishmarket.FishMarketAgent.setSubastando;


/**
 * La clase Subastaa representa el comportamiento que ejecuta la lonja cuando va a
 * subastar un lote.
 */
                        ...
                        if (!isSubastando()) {
                            ...
                            if (!lotesASubastar.isEmpty()) {
                                ...
                                try {
                                    ...
                                    agente.addBehaviour(new SubastaLote(agente, mensajeSubasta, fish, buyers.size()));
                                } catch (Exception e) {
